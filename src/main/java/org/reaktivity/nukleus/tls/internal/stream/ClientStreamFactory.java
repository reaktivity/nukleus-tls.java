            ...
            DataFW data)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    final MutableDirectBuffer inNetBuffer0 = networkPool.buffer(networkReplySlot);
                    inNetBuffer0.putBytes(networkReplySlotOffset, payload.buffer(), payload.offset(), payloadSize);
